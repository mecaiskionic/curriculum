 ...
 */
public class video_molmat2 extends Fragment {

    VideoView video;

    public video_molmat2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_video_molmat2, container, false);

        video=vista.findViewById(R.id.videosoftware);
        Uri uri=Uri.parse("android.resource://com.mecaiskitronic.curriculum/"+R.raw.videomolmat2);
